...
// $(function(){
//     $(".plantmore-product-quantity").children().change(function(){
//         console.log("sssss");
...
// 会员注册
  ...
  $(".fenzu1 li").click(function(){
    $(".tabfen2 div").removeClass("active");
    $(".fenzu2 li").removeClass("active");
  })
  $(".fenzu2 li").click(function(){
    // console.log("dddd");
    $(".tabfen1 div").removeClass("active");
    $(".fenzu1 li").removeClass("active");
    // console.log($(".fenzu1 li").eq(0).attr());
...
$(".plantmore-product-quantity").children().change(function(){
  ...
  var date = $(this).parent().prev().children().text().substr(1);
  console.log(date);
  $(this).parent().next().children().text("$"+""+date * $(this).val());
  $(".product-subtotal").each(function(){
    // console.log($(this).children().text());
     zong +=  parseFloat($(this).children().text().substr(1));
     console.log(zong);
     
  })
  $(".plantmore-product-quantity").each(function(index){
    // console.log($(this).children().text());
    console.log($(this).children().val());
    if(index != 0){
         subzong += parseFloat($(this).children().val());
      
    }
  })
  console.log(subzong);
  // console.log($(".cart-page-tota ul li"));
  console.log($(".cart-page-total span").eq(0));
  
  $(".cart-page-total span").eq(0).text(subzong);
  $(".cart-page-total span").eq(1).text(zong);
